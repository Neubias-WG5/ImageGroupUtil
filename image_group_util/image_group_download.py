...
class ImageGroupDownloader(object):
    """Download images from Image Group or from a project
    """
    ...
    def download_all_image_group_from_project(id_project, output_folder_raw_image,
        ...
        image_groups = ImageGroupCollection().fetch_with_filter("project", id_project)
        for image_group in image_groups:
            ImageGroupDownloader.download_image_group(image_group, True, output_folder_raw_image,
